...
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator ,Request $request, Client $twilioClient): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('gofit2022bythefive@gmail.com:', 'GoFit'))
            ->to($user->getEmail())
