...
class SecurityController extends AbstractController
{
     ...
     */
    public function forgottenPass(Request $request, UtilisateurRepository $usersRepo, \Swift_Mailer $mailer, TokenGeneratorInterface $tokenGenerator){
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $message = (new \Swift_Message('Mot de passe oublié'))
                ...
                ->setTo($user->getEmail())
                ->setBody( $this->renderView('security/mailreset.html.twig', ['url' => $url]
                ),
